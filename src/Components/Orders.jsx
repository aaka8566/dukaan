  ...
  return (
    <Box sx={{padding:"2rem 2rem",display:"grid",rowGap:"1.5rem"}}>
      ...
      <Box sx={{display:"grid",alignItems:"center",gap:"1.5rem"}}>
       <Box><Typography sx={{fontSize:"1.25rem",fontWeight:"500",lineHeight:"1.75rem",fontFamily: "Darker Grotesque,sans-serif"}}>Transactions | This Month</Typography></Box>
      ...
      <Box>
<Box sx={{display:"grid",gridTemplateColumns:"27.5% 14.5%",justifyContent:"space-between",alignItems:"center"}}>
...
<TextField
    ...
    <Box sx={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"1rem"}}>
        <Button variant='outlined' size='medium' sx={{border:"1px solid #D9D9D9",color:"#4D4D4D",padding:"0.38rem 0.75rem"}}>
          <Box sx={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"0.375rem",fontFamily: "Inter"}}>
          <Typography>Sort</Typography> 
          <img style={{width:"1rem",height:"1rem"}}  src="./Sort.png" alt="error" />
          </Box>
          </Button>
